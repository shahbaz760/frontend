...
import { restPassword, setPassword } from "app/store/Auth";
...
import { decodeData, decodeJWT } from "src/utils";
  ...
  async function onSubmit(formData: FormType) {
    ...
    try {
      ...
      if (window.location.href.includes("/set-password")) {
        ...
        response = await dispatch(setPassword(data));
        ...
        response = await dispatch(restPassword(data));
        toast.error(response?.payload?.data?.message);
      }
