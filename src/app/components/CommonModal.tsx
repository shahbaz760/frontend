...
export default function CommonModal({
  ...
  return (
    ...
    >
      ...
      <div
        className={`${bordershow ? "pt-0 pl-20" : " px-20"}  pb-0 pt-10  ${disabled ? "disabledChildren" : ""}`}
      >
        {children}
      </div>
      ...
      {btn && !bordershow && (
        <div
          className={`flex p-20 pt-20 ${
            bordershow
              ? "w-[calc(70%+6px)] border border-r-[#cec9c9] border-t-0 border-b-0 border-l-0 pr-20"
              : ""
          }`}
        >
          {!isIntegrate && (
