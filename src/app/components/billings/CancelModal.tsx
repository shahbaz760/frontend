...
import { CancelIcon } from "public/assets/icons/common";
    ...
    <div>
      <DropdownMenu
        ...
        button={
          ...
          >
            <Typography className=" text-[16px] font-500 flex items-center gap-8 text-red cursor-pointer">
              <CancelIcon /> Cancel
            </Typography>
          </div>
        }
          ...
          {/* {formik.values?.state == "3" ? (
                        <>
                            <div>
                                ...
                                <InputField type="date" name="date" placeholder="22/5/2024" formik={formik} />
                            </div>
                        </>
                    ) : ( */}
          <>
