...
export const navbarSlice = createSlice({
  ...
  reducers: {
    ...
    navbarEditModelOpenMobile: (state) => {
      state.projectEditModel = true;
    },
    navbarEditModelCloseMobile: (state) => {
      state.projectEditModel = false;
    },
    navbarClose: (state) => {
      state.open = false;
    },
...
export const selectFuseNavbar = appSelector(
  ({ navbar }: AppRootStateType) => navbar
);
