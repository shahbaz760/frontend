...
import { financialChurnSlice } from "./financialReport/churnOverview";
import { financialRetentionSlice } from "./financialReport/retentionReport";
import { customerOverviewSlice } from "./financialReport/customerOverview";
import { growthRateSlice } from "./financialReport/growthRate";
import { mrrSlice } from "./financialReport/mrrOverview";
import { financialReportDashboardSlice } from "./financialReport";
...
import customChat from "./customChatBox/index";
import { productSlice } from "./Product";
import { IntegrationSlice } from "./integration";
...
const staticReducers: ReducersMapObject = {
  ...
  financialChurnReport: financialChurnSlice.reducer,
  financialRetentionReport: financialRetentionSlice.reducer,
  financialCustomerOverView: customerOverviewSlice.reducer,
  financialGrowthRate: growthRateSlice.reducer,
  financialMrrOverview: mrrSlice.reducer,
  agentGroup: agentGroupSlice.reducer,
  financialReportDashboard: financialReportDashboardSlice.reducer,
  accManagerSlice: accManagerSlice.reducer,
  project: projectSlice.reducer,
  password: PasswordSlice.reducer,
  clientUser: UserSlice.reducer,
