...
interface ITransferOwnershipProps {
    ...
    */
     ...
     *
     * @defaultValue `public/assets/icons/search.svg`
     */
     ...
     *
     * @defaultValue `public/assets/icons/spinner.svg`
     */
     ...
     *
     * @defaultValue `public/assets/icons/close2x.svg`
     */
...
export function CometChatTransferOwnership(props: ITransferOwnershipProps) {
    const {
        ...
        searchIconURL = "/assets/icons/topBarIcons",
        searchPlaceholderText = "Search",
        hideSearch = false,
        groupMembersRequestBuilder,
        searchRequestBuilder,
        loadingIconURL = "/assets/icons/spinnerIcon.svg",
        loadingStateView,
