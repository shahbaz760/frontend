...
import { SelectionMode, States } from "src/app/pages/Enums/Enums";
import { CometChatContextMenu } from "../BaseComponents/CometChatContextMenu/CometChatContextMenu";
import { CometChatActionsIcon, CometChatActionsView, CometChatOption } from "src/utils/modals";
import emptyIcon from "/assets/icons/user_empty.svg";
import emptyIconDark from "/assets/icons/user_empty_dark.svg";
...
import { useCometChatErrorHandler } from "src/utils/CometChatCustomHooks";
...
export function CometChatUsers(props: UsersProps) {
  ...
  const titleRef = useRef<string>("Users");
      ...
      return (
        <div className="cometchat-users__empty-state-view">
          ...
          <div className="cometchat-users__empty-state-view-body">
            <div className="cometchat-users__empty-state-view-body-title">{"No Users Found"}</div>
            <div className="cometchat-users__empty-state-view-body-description">{"We couldn’t find any users matching your search. Try adjusting your search."}</div>
          </div>
        </div>
      )
    } catch (error) {
      ...
      return (
        <div className="cometchat-users__error-state-view">
          ...
          <div className="cometchat-users__error-state-view-body">
            <div className="cometchat-users__error-state-view-body-title">{"OOPS!"}</div>
            <div className="cometchat-users__error-state-view-body-description">{"Looks like something went wrong"}
            </div>
          </div>
        </div>
      )
