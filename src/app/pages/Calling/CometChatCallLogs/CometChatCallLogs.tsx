...
import emptyIcon from "/assets/icons/call-logs_empty_state.svg";
import emptyIconDark from "/assets/icons/call-logs_empty_state_dark.svg";
...
const CometChatCallLogs = (props: CallLogsProps) => {
  ...
  const titleRef = useRef<string>("Calls");
