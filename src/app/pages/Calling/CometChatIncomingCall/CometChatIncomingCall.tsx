...
import AudioCallIcon from "/assets/icons/Audio-Call.svg";
...
const CometChatIncomingCall = (props: IncomingCallProps) => {
  ...
  const acceptButtonTextRef = useRef<string>("Accept");
  const declineButtonTextRef = useRef<string>("Decline");
  ...
  let incomingcallListenerId: string = "incomingcall_" + new Date().getTime(),
    subtitleText: string = "Incoming Call";
