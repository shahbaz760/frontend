...
const CometChatConversationSummary = (props: CometChatConversationSummaryProps) => {
    ...
    const errorStateText: string = "Looks like something went wrong";
    const emptyStateText: string = "No summary available";
    const titleText: string = "Conversation Summary";
