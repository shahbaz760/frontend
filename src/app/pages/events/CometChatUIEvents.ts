...
export class CometChatUIEvents {
  ...
  static ccActiveChatChanged: Subject<IActiveChatChanged> = new Subject<
    IActiveChatChanged
  >();
  static ccShowOngoingCall: Subject<IShowOngoingCall> = new Subject<
    IShowOngoingCall
  >();
  ...
  static ccShowMentionsCountWarning: Subject<
