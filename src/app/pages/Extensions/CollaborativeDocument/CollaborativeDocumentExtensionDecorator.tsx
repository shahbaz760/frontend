...
import DocumentIcon from "/assets/icons/collabrative_document.svg";
...
import bannerImageUrlLight from "/assets/icons/Collaborative_Document_Light.png";
import bannerImageUrlDark from "/assets/icons/Collaborative_Document_Dark.png";
...
export class CollaborativeDocumentExtensionDecorator extends DataSourceDecorator {
  ...
  */
  ...
  getDocumentContentView(
    ...
    const documentTitle = "has shared a collaborative document";
    const documentButtonText = "Open Document";
    const documentSubitle = "Open document to edit content together";
