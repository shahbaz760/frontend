...
export const selectFuseMessageState = appSelector(
  (state: AppRootStateType) => state.fuseMessage.state
);

export const selectFuseMessageOptions = appSelector(
  (state: AppRootStateType) => state.fuseMessage.options
);
